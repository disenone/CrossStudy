...
namespace pimage.Tools
{
	...
	public static class ResourceLoader
	{
		...
		public static Stream GetEmbeddedResourceStream(string resourceFileName)
		{
            ...
            return GetEmbeddedResourceStream(typeof(ResourceLoader).GetTypeInfo().Assembly, resourceFileName);
        }
		...
		{
			return GetEmbeddedResourceBytes (typeof(ResourceLoader).GetTypeInfo().Assembly, resourceFileName);
		}
		...
		{
			return GetEmbeddedResourceString (typeof(ResourceLoader).GetTypeInfo().Assembly, resourceFileName);
		}
